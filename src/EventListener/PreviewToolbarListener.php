...
namespace ContaoThemesNet\OddThemeBundle\EventListener;
...
class PreviewToolbarListener
{
    ...
    private function injectToolbar(Response $response, Request $request): void
    {
        ...
        $pos = strripos($content, 'id="oddPreviewToolbar"');
        ...
        $toolbar = $this->twig->render('@Contao_ContaoThemesNetOddThemeBundle/Frontend/preview_toolbar.html.twig', [
            'oddColor' => $session->get('odd_color'),
        ]);
